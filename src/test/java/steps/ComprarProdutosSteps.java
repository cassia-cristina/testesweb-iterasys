...
public class ComprarProdutosSteps {
	...
	public void não_estou_logado() {
		assertThat(homePage.estarLogado(), is(false));
	}
	...
	public void o_produto_aparece_na_confirmacao_com_nome_preco_tamanho_cor_e_quantidade(String nomeProduto, String precoProduto, String tamanhoProduto,
