...
public class PedidoPage {
	...
	private By totalProdutos = By.cssSelector("div.order-confirmation-table div.order-line div.row .bold");
	private By totalTaxIncl = By.cssSelector("div.order-confirmation-table table tr.total-value td:nth-child(2)");
	private By metodoPagamento = By.cssSelector("#order-details li:nth-child(2)");
	...
	public String obter_email() {
		//An email has been sent to the cassia@teste.com address.
